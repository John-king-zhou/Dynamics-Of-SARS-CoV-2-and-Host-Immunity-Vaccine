...
def func(x0,time,Para):
    ...
    f_APC_eff=1+h_APC_IFNg*Hill(IFN_g,K_IFNg_1,1)+h_APC_TNF*Hill(TNF,K_TNF_1,1)+h_APC_D*Hill(D,K_D_1,1)
    f_APC_AP=1+h_APC_IFNg*Hill(IFN_g,K_IFNg_1,1)
    f_NK_eff=1+h_NK_IL2*Hill(IL2,K_IL2_1,1)

    A_CD4=f_APC_AP*Hill(APC_l,K_ACD4,2)
    A_CD8=f_APC_AP*Hill(APC_l,K_ACD8,2)
    A_B=f_APC_AP*Hill(APC_l,K_AB,2)
    ...
    dnCoVdt=N1*d_If*If-(f_APC_eff*k_c_1*APC_l+f_APC_eff*k_c_2*APC_u+k_c_3*Neut+k_c_4*A*Ig)*nCoV-d_v*Hill(nCoV,K_m,1)

    dIfdt=k_infect*nCoV*H-(f_APC_eff*k_k_1*APC_l+f_APC_eff*k_k_2*APC_u+f_NK_eff*k_k_3*NK+k_k_4*CTL+k_k_5*CD8Tm)*If-d_If*If

    dHdt=r_H-k_infect*nCoV*H-d_H*H

    dDdt=(f_APC_eff*k_k_1*APC_l+f_APC_eff*k_k_2*APC_u+f_NK_eff*k_k_3*NK+k_k_4*CTL+k_k_5*CD8Tm)*If+d_If*If-d_D*D
    ...
    dNKdt=(k_NK_If*Hill(If,K_If_2,1)+k_NK_APC*Hill(f_APC_eff*APC_l,K_APC_2,1))*NK0-d_NK_Treg*Treg_a*NK-d_NK*NK
    ...
    dIL6dt=p_IL6_0+p_IL6_1*If+p_IL6_2*f_APC_eff*APC_l+p_IL6_3*Neut-c_IL6*IL6

    dIL10dt=p_IL10_0+p_IL10_1*Treg_a+p_IL10_2*Treg_r-c_IL10*IL10

    dTNFdt=p_TNF_0+p_TNF_1*If+p_TNF_2*f_APC_eff*APC_l+p_TNF_3*f_NK_eff*NK-c_TNF*TNF
