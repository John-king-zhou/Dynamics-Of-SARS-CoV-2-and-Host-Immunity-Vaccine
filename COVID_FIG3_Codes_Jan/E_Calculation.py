...
def E(results,Para):
    ...
    e_clear=f_APC_eff*k_c_1*APC_l+f_APC_eff*k_c_2*APC_u+k_c_3*Neut+k_c_4*IgA
    e_kill=f_APC_eff*k_k_1*APC_l+f_APC_eff*k_k_2*APC_u+f_NK_eff*k_k_3*NK+k_k_4*CTL+k_k_5*CD8Tm+d_If
    e=e_clear*e_kill
    return e
...
def E1(results,Para):#innate immunity
    ...
    f_APC_eff=1+h_APC_IFNg*Hill(IFN_g,K_IFNg_1,1)+h_APC_TNF*Hill(TNF,K_TNF_1,1)+h_APC_D*Hill(D,K_D_1,1)
    f_NK_eff=1+h_NK_IL2*Hill(IL2,K_IL2_1,1)
    e_clear_1=f_APC_eff*k_c_1*APC_l+f_APC_eff*k_c_2*APC_u+k_c_3*Neut
    e_kill_1=f_APC_eff*k_k_1*APC_l+f_APC_eff*k_k_2*APC_u+f_NK_eff*k_k_3*NK+d_If
...
def E12(results,Para):
    ...
    e_clear_1=f_APC_eff*k_c_1*APC_l+f_APC_eff*k_c_2*APC_u+k_c_3*Neut
    e_clear_2=k_c_4*IgA
    e_kill_1=f_APC_eff*k_k_1*APC_l+f_APC_eff*k_k_2*APC_u+f_NK_eff*k_k_3*NK
