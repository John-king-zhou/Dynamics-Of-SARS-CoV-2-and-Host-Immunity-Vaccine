...
mode_name = ['Mode 2', 'Mode 3', 'Mode 4', 'Mode 1', ]
...
ax2.add_patch(
    patches.Rectangle((0.255, -0.045),0.025,0.025,facecolor='None',edgecolor='k',zorder=100))
ax2.plot(x,0.15-x,color='k')
ax2.text(x=0.13,y=-0.19,s='slope=-1',rotation=-45,fontsize=12)
ax3.plot([0.255,0.28],[-0.02,-0.045,],color='k')
ax3.text(x=0.255,y=-0.024,s='slope=-1',rotation=-45,ha='left',va='top',fontsize=9)
...
ax3.set_xlim([0.255,0.28])
ax3.set_ylim([-0.045,-0.02])
ax3.set_xticks([])
ax3.set_yticks([])
